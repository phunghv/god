...
public class Conversion {
    ...
    @NotNull
    public static String transform(String text, boolean usePascalCaseWithSpace, boolean useSpaceCase, boolean useKebabCase, boolean useUpperSnakeCase, boolean usePascalCase,
                                   boolean useCamelCase, boolean useLowerSnakeCase, String[] conversionList) {
