...
public final class LombokProcessorUtil {
    ...
    private static final Map<Integer, String> ACCESS_LEVEL_MAP = Map.of(PsiUtil.ACCESS_LEVEL_PUBLIC, ACCESS_LEVEL_PUBLIC, PsiUtil.ACCESS_LEVEL_PACKAGE_LOCAL,
                                                                        ACCESS_LEVEL_PACKAGE_LOCAL, PsiUtil.ACCESS_LEVEL_PROTECTED, ACCESS_LEVEL_PROTECTED,
                                                                        PsiUtil.ACCESS_LEVEL_PRIVATE, ACCESS_LEVEL_PRIVATE);

    private static final Map<String, String> VALUE_ACCESS_LEVEL_MAP = Map.of(ACCESS_LEVEL_PUBLIC, PsiModifier.PUBLIC, ACCESS_LEVEL_PACKAGE_LOCAL, PsiModifier.PACKAGE_LOCAL,
                                                                             ACCESS_LEVEL_PROTECTED, PsiModifier.PROTECTED, ACCESS_LEVEL_PRIVATE, PsiModifier.PRIVATE);
    ...
    public static PsiAnnotation createAnnotationWithAccessLevel(@NotNull PsiModifierListOwner psiModifierListOwner, String annotationClassName) {
        ...
        return createAnnotationWithAccessLevel(psiModifierListOwner, annotationClassName, value.orElse(""));
    }

    @NotNull
    public static PsiAnnotation createAnnotationWithAccessLevel(@NotNull PsiModifierListOwner psiModifierListOwner, String annotationClassName, String value) {
    ...
    public static Optional<String> convertModifierToLombokAccessLevel(@NotNull PsiModifierListOwner psiModifierListOwner) {
        ...
        if (null != modifierList) {
            ...
            if (null != accessLevel && !ACCESS_LEVEL_PUBLIC.equals(accessLevel)) {
                return Optional.of("lombok.AccessLevel" + "." + accessLevel);
            }
        }
