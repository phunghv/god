...
public final class PsiAnnotationUtil {
    ...
    public static PsiField createPsiField(@NotNull PsiModifierListOwner psiModifierListOwner, String fieldName) {
        ...
        return elementFactory.createFieldFromText(fieldName, psiClass);
    }
